...
export function AgentCard({ agent, live, actions }: Props) {
  ...
  return (
    <Link to={`/agents/${agent.id}`} className="block no-underline">
      <div className="glass hover-lift hover-glow relative overflow-hidden rounded-[20px] p-5 cursor-pointer">
        {/* Status dot */}
        <div
