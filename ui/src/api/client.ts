...
export const api = {
  ...
  importSkills: (directory?: string) => request<{ imported: string[]; directory: string; count: number }>("/api/skills/import", { method: "POST", body: JSON.stringify(directory ? { directory } : {}) }),
